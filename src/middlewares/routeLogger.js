...
let requestIpLogger = (req, res, next) => {
    ...
    if (req.method === 'OPTIONS') {
        ...
        headers["Access-Control-Allow-Origin"] = appConfig.allowedCorsOrigin;
        headers["Access-Control-Allow-Methods"] = "POST, GET, PUT, DELETE, OPTIONS";
        headers["Access-Control-Allow-Credentials"] = false;
        headers["Access-Control-Max-Age"] = '86400'; // 24 hours
        headers["Access-Control-Allow-Headers"] = "X-Requested-With, X-HTTP-Method-Override, Content-Type, Accept,token,key, category, authorization, cache-control";
     ...
     res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept,token,key, category");
